...
Adds support for X3D syntax highlighting to Jekyll and allows developers to integrate and display X3D content within their Jekyll websites. The advantage over XML highlighting is that the contents of Script nodes and shader nodes are also highlighted.
